...
const secretVideo = document.getElementById("secretVideo"); // This will now contain the iframe
...
function checkPassword() {
  ...
  if (input === "Morphy") {
    ...
    // Insert the iframe embed for your YouTube video
    secretVideo.innerHTML = `
<iframe width="914" height="514" src="https://www.youtube.com/embed/h3nDr-33Ikw" title="" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    `;
